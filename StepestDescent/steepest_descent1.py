...
def f(x1,x2,x3):
    return 1/4*(((np.sin(x1)-np.sin(x2))*(np.cos(x1)-np.cos(x3))) - ((np.cos(x1)-np.cos(x2))*(np.sin(x1)-np.sin(x3))))


def der_f1(x1,x2,x3):
    return 1/4*(np.sin(x1)*np.sin(x2) - np.sin(x1)*np.sin(x3) + np.cos(x1)*np.cos(x2) - np.cos(x1)*np.cos(x3))


def der_f2(x1,x2,x3):
    return 1/4*(-1*np.cos(x2)*(np.cos(x1)-np.cos(x3)) - np.sin(x2)*(np.sin(x1)-np.sin(x3)))


def der_f3(x1,x2,x3):
    return 1/4*(np.sin(x3)*(np.sin(x1)-np.sin(x2)) + np.cos(x3)*(np.cos(x1)-np.cos(x2)))
...
while counter < 150 and abs(f_son - f_ilk) > 0.00001 :
